...
public class AutoRightTrench10 extends SequentialCommandGroup {
	...
	public AutoRightTrench10(IntakeSubsystem intakeSubsystem) throws IOException {
		super(
            new IntakeRollersSetAuto(intakeSubsystem, 1),
            new AutoFollowPath("output/right_trench10-1.wpilib.json"),
            new IntakeRollersSetAuto(intakeSubsystem, 0),
            new AutoFollowPath("output/right_trench10-2.wpilib.json"),
            new ShooterShoot(Constants.AUTO_SHOOT_SETPOINT),
            new WaitCommand(Constants.AUTO_SHOOT_DURATION),
            new ShooterStop(),
            new IntakeRollersSetAuto(intakeSubsystem, 1),
            new AutoFollowPath("output/right_trench10-3.wpilib.json"),
